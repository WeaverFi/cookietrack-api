...
const id: ChainID = 250;
const nativeToken: Address = '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee';
const nativeTokenOnETH: Address = '0x4e15361fd6b4bb609fa63c81a2be19d873717870';
const wrappedNativeToken: Address = '0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83';
...
const getTaxTXs = async (wallet: Address): Promise<(TaxTransferTX | TaxApprovalTX)[]> => {
  ...
  tokenArray.forEach(token => {
    token === nativeToken ? tokenString += nativeTokenOnETH + ',' : tokenString += token + ',';
  });
